...
if(isset($_POST['change_password'])){
	...
	$sql = "SELECT * FROM stall WHERE ID = '".$_SESSION['kteen_stall_id']."' AND password = '$current_password';";
	...
	if(mysqli_num_rows($result) == 1){//check account exist
		...
		if($new_password == $retype_new_password){
			...
			$sql = "UPDATE stall SET password = '$password' WHERE ID = '".$_SESSION['kteen_stall_id']."'";
