...
<html>
<head>
	<title><link rel="apple-touch-icon-precomposed" sizes="57x57" href="apple-touch-icon-57x57.png" />Welcome</title>
	<meta charset="utf-8">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="card">
                        <div class="row">
                        	<?php
                        		$sql = "select id,stallName, ownerName, email, phoneNo from stall";
                        		$result = $conn -> query($sql);
