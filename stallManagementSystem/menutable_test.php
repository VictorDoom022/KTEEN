            ...
            <div class="modal-content">
                ...
                <form action="menu_test.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="w-100 k-image-edit">
                                    <img src="../images/<?php echo $image; ?>" class="k-edit-img img-fluid mx-auto" style="width: 100%;height: 200px;align-self: center;vertical-align: center;">
                                    <input type="file" name="" class="k-btn-edit-img">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-row">
