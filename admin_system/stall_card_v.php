		...
		<a href="#view<?php echo $stall_id; ?>" data-toggle="modal" style="text-decoration: none;color: black;">
			<div class="k-card card k-hover-shadow h-100">
				<div class="row no-gutters">
					<div class="col-4">
						<img class="rounded-circle p-2" src="../images/<?= $row['username']; ?>/<?php echo $owner_image; ?>" style="width: 100%;height: 100%;align-self: center;vertical-align: center;">
					</div>
					<div class="col-8">
						<div class="card-body">
							<h5 class="card-title">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="position: relative;">
                	<div class="row m-0 p-0" style="position: absolute;top: -60px;">
                		<img class="rounded-circle" src="../images/<?= $row['username']; ?>/<?= $owner_image ?>" style="left: 10px;height: 100px;width: 100px;">
                		<div>
                ...
                <div class="modal-footer">
					<a href="view_menu.php?sid=<?php echo $stall_id; ?>" class="btn text-warning">View Menu</a>
