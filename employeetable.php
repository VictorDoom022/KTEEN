...
<div class="row">
            <?php
                $sql = "SELECT * FROM employee WHERE stall_ID = '".$_SESSION['kteen_stallID']."' AND available = '1'".$filterCategory.$keyword;
            ...
            <div class="card-footer bg-white">
                <div class="row">
                    <div class="col-6 text-center">
                        <a href="#editemployee<?php echo $employee_ID; ?>" data-toggle="modal" class="card-link text-warning mx-auto"><i class="fas fa-pen"></i></a>
                    </div>
                    <div class="col-6 text-center">
                        <a onclick="delete_employee(<?php echo $employee_ID; ?>)" class="card-link text-danger"><i class="fas fa-trash-alt"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="editemployee<?php echo $employee_ID; ?>" tabindex="-1" role="modal">
