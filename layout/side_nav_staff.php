	...
	<div class="k-nav-container h-75">
        <ul class="k-nav nav">
            <li class="nav-item w-100 mb-1">
                <a href="index.php" class="nav-link w-100 text-center text-xl-left <?php if($site == 'Home'){ echo 'active'; } ?>">
                    <i class="fas fa-home d-inline-flex px-auto"></i>
                    <span class="d-none d-xl-inline-flex ml-3">Home</span>
                </a>
            </li>
            <li class="nav-item w-100 mb-1">
                <a href="view_order.php" class="nav-link w-100 text-center text-xl-left <?php if($site == 'Order'){ echo 'active'; } ?>">
                    <i class="fas fa-clipboard-list"></i>
                    <span class="d-none d-xl-inline-flex ml-3">Order List</span>
                </a>
            </li>
            <li class="nav-item w-100 mb-1">
                <a href="menu.php" class="nav-link w-100 text-center text-xl-left <?php if($site == 'Menu'){ echo 'active'; } ?>">
                    ...
                    <span class="d-none d-xl-inline-flex ml-3">Menu</span>
                </a>
            </li>
        </ul>
    </div>
