...
if(isset($_POST['edit_employee'])){
    $name = $name = $position = $image = $salary = "";
    $employee_ID = test_input($_POST['ID']);
    $employeename = test_input($_POST['name']);
    $position = test_input($_POST['position']);
    $image = test_input("S".$id."_".$employeename.".jpg");
    $salary = test_input($_POST['salary']);
    $sql = "UPDATE employee SET name = '$employeename', category = '$category', image = '$image', ";
    $result = $conn->query($sql);
    $target_dir = "../images/";
    $target_file = $target_dir.$image;
    $uploadOk = 1;
